...
public class Assets implements Disposable, AssetErrorListener {
	...
	public ArrayList<Asset> numbers;
	...
	public void init(AssetManager assetManager) {
		...
		/*x = new Asset(atlas, "x");		
		o = new Asset(atlas, "o");*/
		numbers = new ArrayList<Asset>();
		for(int i = 1; i < 10; i++)
			numbers.add(new Asset(atlas, i+""));
		...
		//just to check if they are loaded in the first place or not
		//and it is returning null for one  and numbers.get(0)
		//System.out.println(x.region);
		System.out.println(numbers.get(0).region);
	...
	public class AssetFonts {
		...
		public AssetFonts () {
			...
			defaultSmall = new BitmapFont(Gdx.files.internal("../android/assets/images/arial-15.fnt"), true);
			defaultNormal = new BitmapFont(Gdx.files.internal("../android/assets/images/arial-15.fnt"), true);
			defaultBig = new BitmapFont(Gdx.files.internal("../android/assets/images/arial-15.fnt"), true);
			// set font sizes
	...
	public class AssetSounds {
	    ...
	    public AssetSounds(AssetManager am) {
	        ...
	        //first = Gdx.audio.newSound(Gdx.files.internal("sounds/first.wav"));
