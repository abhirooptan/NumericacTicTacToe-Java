...
public class MenuScreen extends AbstractGameScreen {
    ...
    private Table buildOptionsWindowLayer() {
     ...
     // sound settings
        ...
        // music settings
        optionsWindow.add(new Label("Music Settings",defaultSkin)).colspan(3);
        optionsWindow.row();
        ...
        optionsWindow.setPosition(Constants.VIEWPORT_GUI_WIDTH/4, Constants.VIEWPORT_GUI_HEIGHT/4);
        optionsWindow.setSize((Constants.VIEWPORT_GUI_WIDTH/2)+ Constants.VIEWPORT_WIDTH
        		, (Constants.VIEWPORT_GUI_HEIGHT/2) + 8*Constants.VIEWPORT_HEIGHT);
